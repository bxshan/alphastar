...
int main() {
    ...
    test180(original);
    if (test_same(rearranged, tmp180)) {
        cout << "2";
        return 0;
    }

    test270(original);
    if (test_same(rearranged, tmp270)) {
        cout << "3";
        return 0;
    }

    mirror(original);
    if (test_same(rearranged, tmpmirror)) {
        cout << "4";
        return 0;
    }
    ...
    test180(tmpmirror);
    test270(tmpmirror);
    if (test_same(rearranged, tmp90) || test_same(rearranged, tmp180) ||
        test_same(rearranged, tmp270)) {
        cout << "5";
        return 0;
    }

    if (test_same(rearranged, original)) {
        cout << "6";
        return 0;
    }
